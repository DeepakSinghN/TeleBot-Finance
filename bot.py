...
async def upgrade(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        f"━━━━━━━━━━━━━━━\n"
        f"⭐ *BASIC — ₹299❌ → ₹99/month✅ (for the first 20 users only)*\n"
        f"• 10 alerts\n"
        f"• Check every 2 min\n"
        f"• Alert history\n\n"
        f"🚀 *PRO — ₹499❌ → ₹299/month✅ (for the first 50 users only)*\n"
        f"• Unlimited alerts\n"
        f"• Check every 1 min\n"
        f"• Multiple targets\n"
        f"━━━━━━━━━━━━━━━\n\n"
        ...
        f"UPI ID: `PhonePe: 7252058269@ybl, GPay: dndeepaknegi007@oksbi`\n\n"
        f"After payment:\n"
